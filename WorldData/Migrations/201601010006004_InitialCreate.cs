    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ChartItemId = c.Int(nullable: false, identity: true),
                        ChartId = c.Int(nullable: false),
                        City_CityId = c.Int(),
                    })
                .PrimaryKey(t => t.ChartItemId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ChartItems", "ChartId", "dbo.Charts");
            DropForeignKey("dbo.ChartItems", "City_CityId", "dbo.Cities");
            ...
            DropIndex("dbo.ChartItems", new[] { "City_CityId" });
            DropIndex("dbo.ChartItems", new[] { "ChartId" });
